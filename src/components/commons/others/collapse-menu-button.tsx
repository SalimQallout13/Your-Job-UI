...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger
} from "@/components/commons/ui/collapsible";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
  TooltipProvider
} from "@/components/commons/ui/tooltip";
import {
  DropdownMenu,
  DropdownMenuItem,
  DropdownMenuLabel,
      ...
      <CollapsibleContent className="data-[state=closed]:animate-collapsible-up data-[state=open]:animate-collapsible-down overflow-hidden">
        {submenus.map(({ href, label, active }, index) => (
          <Button
            ...
            asChild
          >
            <Link to={href} onClick={!isDesktop ? closeSidebarMobile : undefined}>
        ...
        <Tooltip delayDuration={100}>
          <TooltipTrigger asChild>
            <DropdownMenuTrigger asChild>
              ...
              >
                <div className="flex w-full items-center justify-between">
                  <div className="flex items-center" onClick={closeSidebarMobile ?? undefined}>
